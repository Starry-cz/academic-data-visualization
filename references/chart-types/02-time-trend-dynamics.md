...
| `horizon-chart` | 时间点或重复观测对象 | time, value | 知识登记 |
...
| `line-chart` | 时间点或重复观测对象 | time, value | 生产已验证 |
...
| `spaghetti-plot` | 时间点或重复观测对象 | time, value | 知识登记 |
...
| 地平线图 / Horizon Chart | `horizon-chart` | 随有序时间或剂量的变化 | 知识登记 |
...
| 折线图 / Line Chart | `line-chart` | 随有序时间或剂量的变化 | 生产已验证 |
...
| 个体纵向轨迹图 / Spaghetti Plot | `spaghetti-plot` | 随有序时间或剂量的变化 | 知识登记 |
...
- **可复用资产**：`templates/production-verified/line-chart`
