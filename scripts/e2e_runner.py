...
SCENARIOS = [
    Scenario(
        ...
        checks=[
            ...
            # Palette
            Check("Accessible categorical palette", pattern=r"#0072B2.*#009E73.*#E69F00"),
            ...
            Check("450 dpi", pattern=r"dpi\s*=\s*450|res\s*=\s*450"),
    ...
    Scenario(
        ...
        checks=[
            ...
            Check("Color baseline", pattern=r"CATEGORICAL\s*=\s*\[.*#0072B2"),
    ...
    Scenario(
        ...
        checks=[
            ...
            Check("Accessible color palette", pattern=r"#0072B2|CATEGORICAL"),
            Check("Arial font", pattern=r"Arial|Helvetica"),
